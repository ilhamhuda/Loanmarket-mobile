...
_pickImage = async (idx) => {
	...
	render() {
		return(
			...
			<View style={{flexDirection:'row',paddingTop:15,alignContent:'space-between'}}>
				...
				<Text style={{fontWeight:'bold',fontSize:15,textAlign:'center',paddingBottom:13,borderBottomWidth:3,borderColor:(this.state.step==1)?'#00a8ea':'#f4f4f4'}}>Step 1</Text>
				</TouchableOpacity>
				<TouchableOpacity style={{flex:1}} onPress={()=>this.setState({step:2})}>
				<Text style={{fontWeight:'bold',fontSize:15,textAlign:'center',paddingBottom:13,borderBottomWidth:3,borderColor:(this.state.step==2)?'#00a8ea':'#f4f4f4'}}>Step 2</Text>
				</TouchableOpacity>
				<TouchableOpacity style={{flex:1}} onPress={()=>this.setState({step:3})}>
				<Text style={{fontWeight:'bold',fontSize:15,textAlign:'center',paddingBottom:13,borderBottomWidth:3,borderColor:(this.state.step==3)?'#00a8ea':'#f4f4f4'}}>Step 3</Text>
				</TouchableOpacity>
			</View>:null}
			...
			<ScrollView style={{flex:1,padding:15}}>
				<View style={{alignItems:'center',flex:1,marginTop:50}}>
					...
					<Text style={{marginTop:15,fontSize:21,color:'#3b544a'}}>Listing Terupload!</Text>					
				</View>
			</ScrollView>:null}
			...
			<ScrollView style={{flex:1,padding:15}}>	
				<KeyboardAvoidingView behavior="padding" enabled>
						...
						<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Pekerjaan</Text>		
				...
				<View style={{flex:1}}>					
					<TextInput style={{height: 40, borderColor: '#ddd', borderRadius:10, paddingHorizontal:15, borderWidth: 1}} placeholder="Pekerjaan" value={this.state.pekerjaan} onChangeText={(pekerjaan) => this.setState({pekerjaan})} />
						...
						<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Alamat Kantor</Text>		
				...
				<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Lama Bekerja</Text>
				...
				<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Tujuan Permohonan Kredit</Text>		
				...
				<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Tujuan Permohonan Kredit (Keterangan)</Text>		
        ...
        <Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Plafond</Text>
				...
				<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Jenis Pinjaman</Text>		
			...
			{(this.state.step==2)?
				...
				<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Jangka Waktu</Text>
				...
				<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Status Menikah</Text>		
        ...
        <Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Nilai Angsuran</Text>
				...
				<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Bank yang diinginkan</Text>		
				...
				<View style={{flex:1}}>					
					<TextInput style={{height: 40, borderColor: '#ddd', borderRadius:10, paddingHorizontal:15, borderWidth: 1}} placeholder="Bank yang diinginkan" value={this.state.bank} onChangeText={(bank) => this.bank} />
        				...
        				<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Pengalaman yang tidak nyaman terkait bank</Text>		
    ...
    <Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Total penghasilan perbulan (RP)</Text>
            ...
            <Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}>Penghasilan lain (sewa,bisnis sampingan) Rp</Text>
          	...
          	<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}><Icon name="file-alt" size={21}/> Dokumen perorangan </Text>
...
<View style={{marginTop:10,flex: 1, flexDirection: 'column'}}>
             ...
             <Text style={{marginLeft:30,marginBottom:10}}>PBB</Text>
				...
				<Text style={{fontSize:20,fontWeight:'bold',marginVertical:15}}><Icon name="camera" size={21}/> Upload Gambar Dokumen </Text>
