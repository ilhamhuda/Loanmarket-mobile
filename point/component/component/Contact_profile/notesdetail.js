      ...
      <Container>
        ...
        <Content style={{borderTopWidth:0,margin:20, borderTopColor: "#e6e9ed"}}>
            ...
            <Item style={{marginTop:10}}floatingLabel last>
              ...
              <Input style={{fontSize:12}} value="BI Checking"/>
            </Item>
            ...
            />
             ...
             <Item style={{marginTop:10}}floatingLabel last>
              ...
              <Input style={{fontSize:12}} value="Slamet Santoso"/>
            </Item>
         <Textarea style={{marginTop:20}}placeholder="Tolong Konfirmasi Tentang Status Mandiri" />
