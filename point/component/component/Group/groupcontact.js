...
export default class Tasks extends Component {
  ...
  render() {
    return (
      ...
      <Container style={{backgroundColor:'#f5f5f5'}}>
        <Header style={{backgroundColor: "white"}}>
          ...
          <Body>
            <Title style={{color: "black", fontSize: 16, fontWeight:'bold'}}>Group Contact</Title>
          </Body>
          <Right>
            <Button transparent onPress={()=>this.props.navigation.navigate('Group_contact_add')}>
              <Icon style={{color: 'black', fontSize: 20}}  name='add' />
            </Button>
          </Right>
        </Header>
  

        <Content style={{ margin:20, backgroundColor:'#f5f5f5'}}>
   ...
   <View style={{flex: 1, flexDirection: 'column',margin:5}}>
              ...
              <Text style={{color:"black", paddingBottom:5, fontSize: 18, fontWeight: "bold"}}>Raywhite Jakarta </Text>
              <Text style={{paddingBottom:10, fontSize: 12, color:"grey"}}>Jln Ciwastra Komplek Pemda no 65</Text>
                ...
                <Button onPress={()=>this.props.navigation.navigate('Group_contact_detail')} transparent style={{backgroundColor:'white',alignItems:'center',flex:1, flexDirection:'row', paddingTop: 1, width: wp('78%'),marginTop:20, borderWidth:1, borderColor: "grey", borderRadius:30,marginRight:wp('4%')}} >
          
                <Text style={{color:"black",marginLeft:90, marginTop:10, paddingBottom:5, fontSize: 12, alignSelf:'center'}}>SEE GROUPS</Text> 
                 </Button>
